...
*/
public class Frm_AbrirCaja extends javax.swing.JFrame {

	private static Frm_AbrirCaja instancia = null;
	...
	public static Frm_AbrirCaja getInstancia(){
		if(instancia == null){			
			instancia = new Frm_AbrirCaja();
		} 
		return instancia;
	}
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				Frm_AbrirCaja inst = new Frm_AbrirCaja();
		...
		if(jButtonCerrar == null) {
			...
			jButtonCerrar.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					...
					try {
						Integer opCajaId = BusinessDelegate.getInstancia().crearOperacionCaja(1, Integer.parseInt(jTextFieldSucursal.getText()));
